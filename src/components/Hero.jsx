  ...
  return (
    <section className="relative h-screen flex items-center justify-center text-white bg-black">
      ...
      <div className="relative z-20 text-center max-w-3xl mx-auto">
        ...
        {/* Set your fixed target date here */}
        <CountdownTimer targetDate="2025-05-10T06:00:00+05:30" />
      </div>
      
      <div className="absolute bottom-12 left-0 right-0 flex justify-center">
        <div className="animate-bounce cursor-pointer" onClick={() => document.getElementById('logo-section')?.scrollIntoView({ behavior: 'smooth' })}>
          <svg 
